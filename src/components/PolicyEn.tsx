  ...
  return (
    <>
      <S.Box>
        ...
        <S.Text>
          Welcome to {COMPANY} that is a service provide chat style memo
          (hereinafter referred to as "service"). The following is "Midnight
          Plan" (CEO Junhyuk Heo, CEO Junhyeok Heo) reads the terms and
          conditions of your {COMPANY} (the "Site"). Contains. “Midnight Plan”
          (hereinafter “Company” or “We”) As a registered company, the business
          number is 489-03-01218. Please read the following terms carefully Read
          and understand clearly. When you use the site, Regardless of the terms
          of use (hereinafter "Terms of Use"), Consider it. If you do not agree
          to these terms and conditions, You cannot collect or continue to use
          the site. In violation of the following terms and conditions Using the
          site may result in civil or criminal penalties. Company You reserve
          the right to change the terms and conditions at any time. Keep you on
          site If you use it, you are deemed to agree to the changed terms and
          conditions. therefore, Users should review any changes to the terms
          and conditions. Inquiries In case, please email us immediately at{' '}
          {CS_EMAIL}.
        </S.Text>
      </S.Box>
      <S.Box>
